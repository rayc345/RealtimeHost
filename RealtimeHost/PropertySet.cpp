...
void CPropertySet::InitializeMostRecentItemsProperties(PCWSTR label, PCWSTR labelDescription, BOOL bPinned)
{
    StringCchCopyW(m_wszLabel, MAX_RESOURCE_LENGTH, label);
    StringCchCopyW(m_wszLabelDescription, MAX_RESOURCE_LENGTH, labelDescription);
    m_bPinned = bPinned;
}
